...
class BloomFilterPerformanceTest:
    ...
    def generate_random_word(self, length=10):
        """
    ...
    def run_tests(self):
        ...
        for _ in range(self.num_runs):
            ...
            search_time = timeit.timeit(
                lambda: self.search_bf(bf, self.dataset), number=1)
    ...
    def print_results(self):
        ...
        """
        print("Bloom Filter Performance Test Results:")
        for i in range(self.num_runs):
            print(f"Run {i + 1}:")
            print(f"  Creation Time: {self.creation_times[i]:.6f} seconds")
            print(f"  Memory Usage: {self.memory_usages[i]:.6f} MB")
            print(
